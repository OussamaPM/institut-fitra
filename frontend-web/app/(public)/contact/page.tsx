              ...
              <div className="bg-white p-4 sm:p-6 md:p-8 rounded-xl shadow-md">
                ...
                <div className="space-y-4 sm:space-y-6">
                  ...
                  <div className="flex items-start">
                    ...
                    <div className="ml-3 sm:ml-4">
                      <h3 className="font-semibold text-secondary mb-0.5 sm:mb-1 text-sm sm:text-base">Telegram</h3>
                      <a href="https://t.me/institut_fitra" target="_blank" rel="noopener noreferrer" className="text-primary hover:underline text-sm sm:text-base">
                        @institut_fitra
                      </a>
                    </div>
                  </div>
