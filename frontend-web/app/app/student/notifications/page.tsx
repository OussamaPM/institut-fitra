    ...
    <div className="p-4 md:p-8">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
          <div>
            <h1 className="font-playfair text-2xl md:text-3xl font-bold text-secondary">
              Notifications
            </h1>
            {unreadCount > 0 && (
        ...
        <div className="flex flex-wrap gap-2 mb-6">
          ...
          {(['payment', 'level', 'session', 'message', 'material'] as NotificationType[]).map((type) => (
            <button
              key={type}
            ...
            {notifications.map((notif) => (
              <div
                ...
                className={`bg-white rounded-lg shadow-sm border p-4 cursor-pointer transition-colors ${
                  notif.read_at ? 'border-gray-100' : 'border-primary/30 bg-primary/5'
                }`}
              >
            ...
            {hasMore && (
              <div className="text-center pt-4">
                <button
                  ...
                  disabled={isLoading}
                  className="px-4 py-2 text-sm text-primary hover:text-primary/80 font-medium disabled:opacity-50"
                >
