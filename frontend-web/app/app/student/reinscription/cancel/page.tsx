...
export default function ReinscriptionCancelPage() {
    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <div className="max-w-md w-full bg-white rounded-2xl shadow-lg p-6 md:p-8 text-center">
        ...
        <p className="text-gray-600 mb-6">
          Vous avez annulé le paiement de votre réinscription.
          Aucun montant n&apos;a été débité et vous pourrez réessayer à tout moment.
        </p>

        <div className="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-6">
          <p className="text-sm text-amber-700">
            Votre réinscription au niveau suivant reste disponible depuis votre tableau de bord.
          </p>
        </div>
